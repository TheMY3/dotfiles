// Blue light filter - soft version
// Based on hyprshade blue-light-filter with higher temperature (less warm)
...
const float temperature = 4000.0;  // Higher = less warm (original: 2600)
const float temperatureStrength = 0.7;  // Lower = softer (original: 1.0)
